...
class SchemasResource(ResourceBase):
    ...
    def activate_routes(cls):
        ...
        def schema_types(
            ...
            if checksum:
                if client:
                    ...
                    clients = schema_client.clients
                    output = {}
                    for client in clients:
                        result = client.checksum()
                        output[client.alias] = {"checksum": result}
                    return output
        ...
        CLIENTS_ENDPOINT = "/schema/clients"

        @cls.router.get(CLIENTS_ENDPOINT,
        ...
        def schema_clients(
            ...
            for client in dcfg["schema"]["clients"]:
